...
plugin.onLangLoaded = function() {
    ...
    this.addButtonToToolbar("bib", theUILang.bib, "location.href='https://bibliotik.me'", "help");
    this.addButtonToToolbar("bs", theUILang.bs, "location.href='https://brokenstones.club'", "help");
    ...
    this.addButtonToToolbar("emp", theUILang.emp, "location.href='http://www.empornium.me'", "help");
    ...
    this.addButtonToToolbar("l13", theUILang.l13, "location.href='https://layer13.net'", "help");
    ...
    this.addButtonToToolbar("ptm", theUILang.ptm, "location.href='https://pretome.info'", "help");
    ...
    this.addButtonToToolbar("tl_beta", theUILang.tl_beta, "location.href='https://beta.torrentleech.org'", "help");
